...
print("Uso el metodo index con el elemento 'i':", vocales.index("i"), end="\n\n")

print("Uso el metodo index con el elemento 'e':", vocales.index("e"), end="\n\n")


print("Uso el metodo index con el elemento 'a':", vocales.index("a"), end="\n\n")

# Si le indico un inicio como 2, revisara primero el elemento vocales[2], y luego el siguiente
print(
    "Uso el metodo index con el elemento 'a' y el inicio 2:",
    vocales.index("a", 2),
    end="\n\n",
)
...
print(
    "Uso el metodo index con el elemento 'a', el indice 2 y el fin 6:",
    vocales.index("a", 2, 6),
    end="\n\n",
)
